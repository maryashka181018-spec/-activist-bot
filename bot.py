...
ROLE_DESCRIPTIONS = {
    ...
    "Ответственный": (
        ...
        "• корреспондент взял интервью и вышел на камеру\n"
        "• видеографы не упустили ключевые кадры\n"
        "• в конце определяешь кто монтирует материал\n\n"
...
WELCOME_TEXT = (
    ...
    "🎤 *Корреспондент* — выходит на камеру и берёт интервью\n"
    "📋 *Ответственный* — контролирует всю команду на месте\n\n"
